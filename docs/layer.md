...
「カラーバランス」では、例えば、「ハイライト」に RGB(30, 30, 0) あたりをセットし、
「シャドウ」に RGB(30, 0, 120) あたりをセットすることで、描画内容の明るい部分に黄色要素を追加し、
暗い部分に青紫要素を追加することできます。
「カラーバランス」の「2 つ目の位置」とは中間調の位置のことです。

調整レイヤーは「クリッピングマスク」をオンにすることで、下にあるレイヤーにのみ効果を与えることができます。

調整レイヤーにレイヤーマスクを作成することで、効果を与える部分を指定することもできます。
...
レイヤーマスクもコピーペーストします。選択範囲がないなら丸ごとコピーペーストします。
